...
if (order) {
    ...
    el.innerHTML = `
        ...
        <div class="flex justify-between text-stone-600 text-sm">
            ...
            <span class="font-bold text-stone-900" id="govDisplay">${escapeHTML(order.governorate)}</span>
        </div>
